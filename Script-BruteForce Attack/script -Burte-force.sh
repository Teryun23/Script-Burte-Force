...
echo -e "		$Cyan 3 : Brute Force Instagram Hesabı 1$nc"
echo -e "		$Cyan 4 : Brute Force Twitter Hesabı$nc"
echo -e "		$Cyan 5 : Brute Force Instagram Hesabı 2 $nc"
echo -e "		$Cyan 99: Cıkış Yap$nc"
read -p "Choice >  " ch
if [ $ch = 1 ]; then
...
echo -e "$red"
read -p "Ana Menüye Dönmek İstermisiniz [ Y / n ] : " check
echo -e "$nc"
if [ $check = "Y" ]; then
...
echo -e "               [+]$yellow Brute Force Tamamlandı $nc[$green✓$nc] $nc[+]"
echo -e "$red"
read -p "Ana Menüye Dönmek İstermisiniz [ Y / n ] : " check2
echo -e "$nc"
if [ $check2 = "Y" ]; then
cd .. && bash SocialBox.sh
elif [ $check2 = "y" ]; then
...
echo -e "$red"
read -p "Ana Menüye Dönmek İstermisiniz [ Y / n ] : " check3
echo -e "$nc"
if [ $check3 = "Y" ]; then
cd .. && bash SocialBox.sh
elif [ $check3 = "y" ]; then
...
echo -e "		[+]$red Service Tor Stopped$nc [+]"
echo -e "$red"
read -p "Ana Menüye Dönmek İster misiniz ? [ Y / n ] : " check4
echo -e "$nc"
if [ $check4 = "Y" ]; then
cd .. && bash SocialBox.sh
elif [ $check4 = "y" ]; then
...
cd insta-bf/
sleep 0.025
        echo -e "	[+]$red Servis Tor Başlatıldı $nc[+]"
sleep 0.9
sv tor start
python instabf.py
echo -e "               [+]$yellow Brute Force Tamamlandı $nc[$green✓$nc] $nc[+]"
sv tor stop
echo -e "		[+]$red Servis Tor Durduruldu$nc [+]"
echo -e "$red"
read -p "Ana Menüye Dönmek İster misiniz ? [ Y / n ] : " check5
echo -e "$nc"
if [ $check5 = "Y" ]; then
cd .. && bash SocialBox.sh
elif [ $check5 = "y" ]; then
...
echo -e "$red Program Çıkıyor ...$nc"
sleep 0.25
exit 1
else
echo "Not Found 404 , Çıkış"
exit 1
fi
